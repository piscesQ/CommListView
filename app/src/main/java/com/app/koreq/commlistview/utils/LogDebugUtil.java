 ...
 * author : YanBin on 4/24/17
 * version : v3.2
 * description : my debug utils
 */
...
//            output.write(minus.);
//            output.writeUTF(tag+"\n");
//            output.close();   //这个输出流不关闭，影响速度，这里只是测试
        } catch (IOException e) {
            e.printStackTrace();
        }
        mMap.put(key, value);
    ...
    public static void writeLog(String key, String content) {
        ...
        String logInfo = key + " \t -- " + content + " \t -  " + strTime + "\n";
        Log.e("LogDebugUtil ", "logInfo = " + logInfo);
    ...
    private static String getLogDir() {
        ...
        path = absolutePath + File.separator + "kore_log" + File.separator + "log.txt";
        return path;
    }
