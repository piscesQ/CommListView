...
import retrofit2_source.HttpException;
...
/**
 * A {@linkplain retrofit2_source.CallAdapter.Factory call adapter} which uses RxJava for creating observables.
 * <p>
 ...
 * stable by RxJava.
 */
public final class RxJavaCallAdapterFactory extends retrofit2_source.CallAdapter.Factory {
  /**
  ...
  @Override
  public retrofit2_source.CallAdapter<?, ?> get(Type returnType, Annotation[] annotations, Retrofit retrofit) {
    ...
    if (isCompletable) {
      return new retrofit2_source.adapter.rxjava.RxJavaCallAdapter(Void.class, scheduler, isAsync, false, true, false, true);
    }
    ...
    return new retrofit2_source.adapter.rxjava.RxJavaCallAdapter(responseType, scheduler, isAsync, isResult, isBody, isSingle,
        false);
  }
}
