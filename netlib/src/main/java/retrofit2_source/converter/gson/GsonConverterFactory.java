 ...
 */
package retrofit2_source.converter.gson;
...
/**
 * A {@linkplain retrofit2_source.Converter.Factory converter} which uses Gson for JSON.
 * <p>
 * Because Gson is so flexible in the types it supports, this converter assumes that it can handle
 * all types. If you are mixing JSON serialization with something else (such as protocol buffers),
 * you must {@linkplain retrofit2_source.Retrofit.Builder#addConverterFactory(retrofit2_source.Converter.Factory) add this instance}
 * last to allow the other converters a chance to see their types.
 */
public final class GsonConverterFactory extends retrofit2_source.Converter.Factory {
  /**
