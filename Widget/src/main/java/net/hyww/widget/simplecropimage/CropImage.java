...
package net.hyww.widget.simplecropimage;
...
public class CropImage extends MonitoredActivity {
    ...
    public static final  String IMAGE_PATH_OUT_PUT     = "image-path-out-put";
    ...
    private String          mImagePathOutPut;
    ...
    public void onCreate(Bundle icicle) {
        ...
        if (extras != null) {
            ...
            mImagePathOutPut = extras.getString(IMAGE_PATH_OUT_PUT);
            ...
            if (TextUtils.isEmpty(mImagePathOutPut)){
                mImagePathOutPut = mImagePath;
            }
            mSaveUri = getImageUri(mImagePathOutPut);
        ...
        findViewById(R.id.rotateLeft).setOnClickListener(
                new View.OnClickListener() {
                    public void onClick(View v) {
                        ...
                        mBitmap = CropImageUtil.rotateImage(mBitmap, -90);
    ...
    private Bitmap getBitmap(String path) {
        ...
        try {
            ...
            if (o.outHeight > IMAGE_MAX_SIZE || o.outWidth > IMAGE_MAX_SIZE) {
                final int heightRatio = new BigDecimal((float) o.outHeight / (float) IMAGE_MAX_SIZE).setScale(0, BigDecimal.ROUND_HALF_UP)
                        .intValue();
                final int widthRatio = new BigDecimal((float) o.outWidth  / (float) IMAGE_MAX_SIZE).setScale(0, BigDecimal.ROUND_HALF_UP)
                        .intValue();
...
//                scale = (int) Math.pow(2, (int) Math.round(Math.log(IMAGE_MAX_SIZE / (double) Math.max(o.outHeight, o.outWidth)) / Math.log(0.5)));
            ...
            if (degree != 0) {// 旋转照片角度
                b =  CropImageUtil.rotateImage(b, degree);
            }
            in.close();
    ...
    private void startFaceDetection() {
        ...
        CropImageUtil.startBackgroundJob(this, null,
                "Please wait\u2026",
                new Runnable() {
                    public void run() {
    ...
    private void onSaveClicked() throws Exception {
        ...
        if (mOutputX != 0 && mOutputY != 0) {
            ...
            if (mScale) {
                ...
                croppedImage = CropImageUtil.transform(new Matrix(),
        ...
        if (myExtras != null && (myExtras.getParcelable("data") != null
            ...
            CropImageUtil.startBackgroundJob(this, null, getString(R.string.saving_image),
                    new Runnable() {
                        public void run() {
    ...
    private void saveOutput(Bitmap croppedImage) {
        ...
        if (mSaveUri != null) {
            ...
            intent.putExtra(IMAGE_PATH, mImagePathOutPut);
