...
//                }
     ...
     * through to {@link net.hyww.widget.dragsort.DragSortListView.DropListener#drop(int, int)}.
     * 
    ...
    public interface FloatViewManager {
         ...
         * and the offset provided in {@link net.hyww.widget.dragsort.DragSortListView#startDrag}.
     ...
     * {@link net.hyww.widget.dragsort.DragSortListView.DragScrollProfile}.
     * 
     * @param ssp
     */
     ...
     * {@link net.hyww.widget.dragsort.DragSortListView#setDragScrollProfile(net.hyww.widget.dragsort.DragSortListView.DragScrollProfile)} to
     * set custom profile.
     * 
     * @author heycosmo
     *
