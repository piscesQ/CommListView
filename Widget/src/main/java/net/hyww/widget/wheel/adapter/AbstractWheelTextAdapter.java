...
public abstract class AbstractWheelTextAdapter extends AbstractWheelAdapter {
     ...
     * Default text color
     */
    public static final int DEFAULT_TEXT_COLOR = 0xFF7FC44D;

    /**
     * Default text color
     */
    public static final int LABEL_COLOR = 0xFF666666;
        ...
        if (index >= 0 && index < getItemsCount()) {
            ...
            if (textView != null) {
                ...
                if (index == currentIndex) {  //把当前选中item字体改大，其余的变小
                    textView.setTextColor(context.getResources().getColor(R.color.color_92c659));
    ...
    protected void configureTextView(TextView view,int index) {
        if (index == currentIndex) {  //把当前选中item字体改大，其余的变小
            view.setTextColor(context.getResources().getColor(R.color.color_92c659));
            view.setTextSize(maxsize);
        } else {
            view.setTextColor(context.getResources().getColor(R.color.color_999999));
            view.setTextSize(minsize);
        }
        if (currentIndex == -1) {
...
//            text.setTextColor(context.getResources().getColor(R.color.color_000000));
