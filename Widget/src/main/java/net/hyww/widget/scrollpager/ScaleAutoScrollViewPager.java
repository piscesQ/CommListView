...
public class ScaleAutoScrollViewPager extends ViewPager {
    ...
    public ScaleAutoScrollViewPager(Context paramContext) {
        super(paramContext);
        init();
    }

    public ScaleAutoScrollViewPager(Context paramContext, AttributeSet paramAttributeSet) {
...
//        heightMeasureSpec = MeasureSpec.makeMeasureSpec(height, MeasureSpec.EXACTLY);
    ...
    public void setScaleInfo(int scale_width,int scale_height){
        this.scale_width=scale_width;
        this.scale_height=scale_height;
    }

    public void setBaseAsWidth(Boolean asWidth){
        this.base_as_width=asWidth;
    }
}
